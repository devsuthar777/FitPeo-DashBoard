...
const NetProfit = () => {
  return (
    <div
    className='w-[35%] bg-richblack-700 rounded-md flex flex-col justify-between px-2 relative'
    >
      ...
      <div>
        ...
        <p className='text-sm text-richblack-50 absolute right-0 bottom-0 py-1'>The value here has been rounded off.</p>
      </div>
    </div>
  )
}
