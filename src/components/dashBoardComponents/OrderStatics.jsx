      ...
      <>
        {
          orderDetails.map((data,index) => 
            ...
            <div className='sm:w-52 w-[100%] h-32 bg-richblack-800 rounded-md flex flex-col relative' key={index}>
                ...
                <div className='absolute bottom-0 right-1 flex items-center'>
                  {
                    data.increment>0 ? (
                      ...
                      <p className='text-caribbeangreen-300 font-bold'>{data.increment} % </p>
                      </>
                      ) 
                    : 
                    (
