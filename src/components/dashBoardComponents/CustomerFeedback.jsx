        ...
        <div className='overflow-hidden max-h-[80%] overflow-y-scroll'>
            {
                ...
                <div className='px-2 py-4 '>
                    <p className='w-[35%] flex items-center text-white'><img className="rounded-full w-7 mx-1 " src={`https://randomuser.me/api/portraits/thumb/men/5${index}.jpg`} alt="img"></img><span className='px-2'>{data.name}</span></p>
